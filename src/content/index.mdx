---
title: "Lesson 1: The Storyteller died in the night."
sidebarTitle: Index
asIndexPage: true
---
...
Unlike other social deduction games, _everyone gets a unique ability_ -- and **you keep playing even after you die**.<br/>
...
1. Check out the main channel for details.
2. Watch for the **weekly signup message**.
3. Register to the event on Clocktracker to join.
4. Reserve about **90 minutes** for a session.
...
- **Ask in the channel** for a quick rules explanation that will happen *before the scheduled game start*.
